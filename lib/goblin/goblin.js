...
Goblin.CharacterController.prototype.move = function(direction, deltaTime) {
    // Store raw input direction for debug
   ...
   // Store for debug
   this._lastHorizontalSpeed = currentHorizontalSpeed;
   return;
}
    ...
    // Store final applied force for debug
...
Goblin.CharacterController.prototype.getDebugInfo = function() {
    ...
    var movement = {
        ...
        horizontal_speed: this._lastHorizontalSpeed || 0,
        stop_factor: this.stopFactor,
        stopping_threshold: this.stoppingThreshold
    };
