...
class BaseDebugPanel {
    constructor(debugCanvas, game, options = {}) {
        ...
        this.tabs = options.tabs || [{ id: "main", label: "Main" }];
            ...
            // For continuous sliders
                ...
                if (slider.min !== undefined && slider.max !== undefined) {
                    ...
                    displayPercentage = Math.max(
                        0,
                        Math.min(1, (slider.value - slider.min) / (slider.max - slider.min))
                    );
                }
    ...
    drawToggleButton() {
        ...
        this.ctx.fillRect(this.toggleButton.x, this.toggleButton.y, this.toggleButton.width, this.toggleButton.height);
