    ...
    constructor(debugCanvas, game) {
        ...
        this.shadowSliders = {
            ...
            "Default Shader Intensity Factor": {
                value: this.constants.OBJECT_SHADER_DEFAULT_VARIANT_INTENSITY_FACTOR.value,
                min: this.constants.OBJECT_SHADER_DEFAULT_VARIANT_INTENSITY_FACTOR.min,
                max: this.constants.OBJECT_SHADER_DEFAULT_VARIANT_INTENSITY_FACTOR.max,
                step: this.constants.OBJECT_SHADER_DEFAULT_VARIANT_INTENSITY_FACTOR.step,
                id: "objectShaderDefaultVariantIntensityFactor",
                updateProperty: (value) => { this.constants.OBJECT_SHADER_DEFAULT_VARIANT_INTENSITY_FACTOR.value = value; }
            },
            "Softness": {
