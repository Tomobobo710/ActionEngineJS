class Fisher {
   ...
   update(deltaTime, input) {
       ...
       switch (this.state) {
           case "ready":
               this.handleReadyState(deltaTime, input);
               break;
           case "casting":
               ...
               break;
           case "fishing":
               this.handleFishingState(input, deltaTime);
               break;
           case "reeling":
               this.handleReelingState(deltaTime);
               break;
           case "caught":
               this.handleCaughtState(input);
               break;
       }
   }

   handleReadyState(deltaTime, input) {
